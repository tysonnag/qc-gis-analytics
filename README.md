# qc-gis-analytics
End-to-end data analytics project combining SQL, Power BI, and GIS to analyze order density, service coverage, SLA performance, and site-level optimization in quick commerce operations.
# Quick Commerce GIS & Operations Analytics

## Project Overview
This project demonstrates how data analytics, SQL, Power BI, and GIS-based
analysis can be used to optimize service coverage, improve SLA performance,
and balance operational load across multiple quick commerce sites.

## Business Problem
Quick commerce sites often face overlapping service areas, uneven order
distribution, and SLA breaches due to inefficient geo-mapping and routing.
This project analyzes order density, site polygons, and delivery metrics to
...
- OTI, ITR, RTD, OTD time metrics
- SLA thresholds and performance indicators

## Analysis Performed
- GIS polygon and radius-based coverage analysis
- Order density and overlap identification
- SLA and delivery performance analysis
- Pre vs post remapping comparison
...
- GIS (polygons, radius mapping, geo-visualization)
